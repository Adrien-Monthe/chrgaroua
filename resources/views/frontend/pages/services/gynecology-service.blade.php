...
@section('page-title', __('gynecology-service.page-img-title'))
@section('image-banner',  asset('frontend/images/blog/26.jpg'))
    ...
    <div class="pq-menu-content">
        ...
        <div class="pq-section-title-box pq-section-title-style-2 pt-4">
            ...
            <div class="pq-section-description">
                <p style="text-align: justify"> <strong>Dans le domaine gynéco obstétrique, le CHR de Garoua </strong> est doté d'un plateau technique de plus haut niveau de référence de la région avec des capacités permettant d'atteindre un minimum de 3500 naissances annuelles. C'est le grand pavillon réservé à la prise en charge de la mère et de l'enfant. Il est composé des services de gynécologie-obstétrique, de néonatalogie et de pédiatrie. </p>
                <p style="text-align: justify"> <strong>Le service de néonatalogie</strong><br>
        ...
        <div class="row">
            ...
            <div class="pq-section-description">
                <p style="text-align: justify"> <strong>Le service pédiatrique</strong><br>
                ...
                <p style="text-align: justify"><strong>Le service de gynécologie obstétrique</strong>
