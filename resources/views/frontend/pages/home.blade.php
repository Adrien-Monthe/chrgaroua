        ...
        <rs-module id="rev_slider_24_1" data-version="6.5.19">
            <rs-slides >
                ...
                <rs-slide style="position: absolute;" data-key="rs-83" data-title="Slide"
                    ...
                    <img src="{{asset('frontend/images/home/IMG_8410.JPG')}}" alt="" title="3-2"
                    ...
                    -->
                     ...
                     <rs-layer id="slider-24-slide-86-layer-2" data-type="text" data-color="#18100f" data-rsp_ch="on"
                               data-xy="xo:30px,30px,30px,31px;y:m;yo:-305px,-75px,-50px,-30px;"
                               ...
                               style="z-index:10; font-weight: bolder">Bienvenue au
                         CHR GAROUA
                     </rs-layer>
                     <!--
                     -->
                ...
                <rs-slide style="position: absolute;" data-key="rs-84" data-title="Slide"
                          ...
                          data-out="a:false;">
                    <img src="{{asset('frontend/images/home/IMG_8415.JPG')}}" alt="" title="1-51.jpg"
                         class="rev-slidebg tp-rs-img" data-no-retina>
                    <!--
                    -->
                ...
                <rs-slide style="position: absolute;" data-key="rs-85" data-title="Slide"
                    ...
                    <img src="{{asset('frontend/images/home/image_5.jpg')}}" alt="" title="2-51.jpg"
                         class="rev-slidebg tp-rs-img" data-no-retina>
                    <!--
                    -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-us-img">
                        <img src="/frontend/images/blog/2.jpg" class="img-fluid pq-image1 wow fadeInRight " alt="home">
                        <img src="/frontend/images/blog/3.jpg" class="img-fluid pq-image2 wow fadeInRight " alt="home">
                    </div>
