<section class="testimonial pg-border-bottom pq-testimonial-pt">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center"> <span class="pq-section-sub-title">@lang('about.our-clients')</span>
                    <h5 class="pq-section-title">@lang('about.our-clients_text')</h5> </div>
            </div>
            <div class="col-lg-12">
