...
<section class="pq-blog  pq-pb-210">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="pq-section pq-style-1 text-center"> <span class="pq-section-sub-title">@lang('blog-area.our-blog')</span>
                    <h5 class="pq-section-title">@lang('blog-area.our-blog-text')</h5> </div>
            </div>
            <div class="col-lg-12">
