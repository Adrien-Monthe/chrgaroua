                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="pq-footer-block">
                            <img src="{{ asset('frontend/images/logo_chr_transp.png')}}" class="pq-footer-logo img-fluid" alt="medicate-footer-logo" >CHR GAROUA
                        ...
                        <div class="pq-footer-block">
                            ...
                            <div class="menu-useful-links-container">
                                <ul id="menu-useful-links" class="menu">
                                    <li><a href="{{ route('home', app()->getLocale() ) }}">@lang('footer.nav-home')</a></li>
                                    <li><a href="{{ route('about', app()->getLocale() ) }}">@lang('footer.nav-about-us')</a></li>
                                    <li><a href="{{ route('contact', app()->getLocale() ) }}">@lang('footer.nav-contact')</a></li>
                                    <li><a href="{{ route('services', app()->getLocale() ) }}">@lang('footer.nav-services')</a></li>
                                    <li><a href="{{ route('appointment', app()->getLocale() ) }}">@lang('footer.nav-appointment')</a></li>
                        ...
                        <div class="pq-footer-block">
                            ...
                            <div class="pq-footer-recent-post">
                                <div class="pq-footer-recent-post-media">
                                    <a href="get-the-exercise-limited-mobility.html"> <img src="{{ asset('frontend/images/footer-image/1.jpg')}}" alt=""></a>
                                </div>
                            ...
                            <div class="pq-footer-recent-post">
                                <div class="pq-footer-recent-post-media">
                                    <a href="get-the-exercise-limited-mobility.html"> <img src="{{ asset('frontend/images/footer-image/2.jpg')}}" alt=""></a>
                                </div>
                                <div class="pq-footer-recent-post-info">
                                    <a href="get-the-exercise-limited-mobility.html" class="pq-post-date"> <i class="far fa-calendar-alt"></i>December <span>12</span>, 2021 </a>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <ul class="pq-contact">
                                        ...
                                        <li> <a href=""><i class="fas fa-envelope"></i><span>contact@chr-garoua.cm</span></a> </li>
